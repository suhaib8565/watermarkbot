...
async def HelpWatermark(bot, cmd):
	...
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/The_dsr"), InlineKeyboardButton("Support Group", url="https://t.me/Dsrs_Group")], [InlineKeyboardButton("Bots Channel", url="https://t.me/kashir_bots")], [InlineKeyboardButton("About me", url="https://t.me/The_dsr")]]),
...
async def VidWatermarkAdder(bot, cmd):
	...
	output_vid = main_file_name + "_[" + str(cmd.from_user.id) + "]_[" + str(time.time()) + "]_[@kashir_bots]" + ".mp4"
...
async def button(bot, cmd: CallbackQuery):
	...
	if "refreshmeh" in cb_data:
		...
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/The_dsr"), InlineKeyboardButton("Support Group", url="https://t.me/Dsrs_Group")], [InlineKeyboardButton("Bots Channel", url="https://t.me/kashir_bots")]]),
			disable_web_page_preview=True
		)
